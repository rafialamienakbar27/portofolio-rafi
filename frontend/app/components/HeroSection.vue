...
<template>
  <section ref="heroRoot" id="home" class="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden">
    ...
    <!-- Glow orb -->
    <div
      class="absolute -top-32 -right-32 w-[600px] h-[600px] rounded-full bg-ember/10 blur-[120px] pointer-events-none animate-pulse-slow" />
    ...
    <div class="relative max-w-7xl mx-auto px-6 w-full">
      <div class="grid lg:grid-cols-12 gap-8 items-end">
        <div class="lg:col-span-9">
          ...
          <!-- Tagline -->
          <p data-hero-tagline class="mt-8 max-w-2xl text-lg md:text-xl text-bone-300 text-balance leading-relaxed">
          ...
          <div data-hero-cta class="mt-10 flex flex-wrap items-center gap-4">
            <a :href="profile?.cv_url || '#'" target="_blank" rel="noopener" class="group inline-flex items-center gap-3 px-6 py-3.5 rounded-full
            ...
            <button @click="scrollToProjects" class="group inline-flex items-center gap-2 px-6 py-3.5 rounded-full
                     border border-ink-600 text-bone-100
                     hover:border-ember hover:text-ember transition">
              <span>See my work</span>
              <svg class="w-3.5 h-3.5 transition-transform group-hover:translate-y-0.5" viewBox="0 0 24 24" fill="none"
        ...
        <div class="lg:col-span-3 hidden lg:block">
          <div data-hero-portrait class="relative">
            <div class="aspect-[3/4] rounded-2xl overflow-hidden border border-ink-600 bg-ink-800 relative">
              ...
              <!-- Overlay tag -->
              <div
                class="absolute bottom-3 left-3 right-3 bg-ink-900/80 backdrop-blur rounded-lg px-3 py-2 font-mono text-xs">
